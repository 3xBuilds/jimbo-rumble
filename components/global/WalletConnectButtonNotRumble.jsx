  ...
  return (
    <>
      {provider?.isConnected ?
        <button className={` cursor-pointer rounded-xl w-48 h-16 truncate absolute z-[70] top-7 max-md:text-[1rem] right-[1.8vw] text-white bg-black border-[1px] border-white duration-200 hover:-translate-y-1`} onClick={handleDisconnect}>
        ...
        <button className={`cursor-pointer rounded-xl w-48 h-16 absolute top-7 max-md:text-[1rem] right-[3vw] z-[70] text-white bg-black border-[1px] border-white duration-200 hover:-translate-y-1`} onClick={handleConnect}>
          Wallet Connect
        </button>
      }
